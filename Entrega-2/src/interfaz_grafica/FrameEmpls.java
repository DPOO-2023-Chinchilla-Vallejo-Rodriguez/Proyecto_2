...
public class FrameEmpls extends JFrame{
	...
	private AggEmpls crear;
	private DelEmpls eliminar;
	private JPanel panelAgregar;
	
	public FrameEmpls (Inicio_sesion padre) throws Exception
	{
		this.padre = padre;
...
//        setResizable( false );
        ...
        crear = new AggEmpls( this);
        panelAgregar.add(crear, BorderLayout.WEST);
        
        eliminar = new DelEmpls( this, padre);
