...
public class Categoria_vehiculo {
    ...
    public static List<String> obtenerInformacionCategorias() {
        List<Categoria_vehiculo> categorias = Reservas.getCategoria();
        List<String> informacionCategorias = new ArrayList<>();

        for (Categoria_vehiculo categoria : categorias) {
            String infoCategoria = "Nombre: " + categoria.getNombre() +
                                   ", Descripción: " + categoria.getDescripcion() +
                                   ", Tarifa diaria: " + categoria.getTarifaDiaria();
